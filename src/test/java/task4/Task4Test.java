...
//    public void test1() {
//        pageManager.getStartPage_task4().verifyHomePageUrl().goToSearch().enterSearchQuery("Пудра").logFirstThreeProducts("Пудра").checkProductPrice().checkPriceAndName();
//
//        try {
//            Thread.sleep(10000);
...
//    }
    ...
    public void test2() {
        pageManager.getStartPage_task4().verifyHomePageUrl().clickOnButtonLocation().moveToCatalog().findNameCategory("Волосы").sortByAscendingPrice().hoverAndClickFirstProduct().verifyAddToCartNotification();
